...
/*   Updated: 2020/10/01 15:23:31 by lindsay       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lodevsprites(t_data *d)
{
	...
	//do no transformation on sprites
	// double invDet = 1.0;
	// double transformX = invDet * spriteX;
	// double transformY = invDet * spriteY;
	...
	//transform sprite with the camera matrix
      // [ r.xplane   pxdir ]									  	[ r.xplane   pxdir ]
      // [                  ]	=   1                           * 	[                  ]
      // [ r.yplane   pydir ]									  	[ r.yplane   pydir ]

	//	double invDet = 1.0;
    //   double transformX = invDet * (d->r.xplane * spriteX + d->r.pxdir * spriteY);
    //   double transformY = invDet * (d->r.yplane * spriteX + d->r.pydir * spriteY); 
